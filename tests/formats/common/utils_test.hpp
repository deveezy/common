...
TYPED_TEST_P(FormatsGetAtPathValueBuilder, NonObjectElemOnPath) {
  ...
  ASSERT_THROW(formats::common::GetAtPath(origin, std::move(path)), typename TestFixture::Exception);
}
...
REGISTER_TYPED_TEST_SUITE_P(FormatsGetAtPathValueBuilder, One, NonObjectElemOnPath, Odd, Even);
...
REGISTER_TYPED_TEST_SUITE_P(FormatsGetAtPathValue, Empty, One, Odd, Even, NonObjectElemOnPath);
...
TYPED_TEST_P(FormatsSetAtPath, NonObjectElemOnPath) {
  ...
  // possible false positive because of conditional in catch?
  // NOLINTNEXTLINE(misc-throw-by-value-catch-by-reference)
  ASSERT_THROW(formats::common::SetAtPath(origin, std::move(path), new_elem), typename TestFixture::Exception);
}
...
REGISTER_TYPED_TEST_SUITE_P(FormatsSetAtPath, Empty, One, Odd, Even, NonObjectElemOnPath);
...
TYPED_TEST_P(FormatsRemoveAtPath, NonObjectElemOnPath) {
  ...
  // possible false positive because of conditional in catch?
  // NOLINTNEXTLINE(misc-throw-by-value-catch-by-reference)
  ASSERT_THROW(formats::common::RemoveAtPath(origin, std::move(path)), typename TestFixture::Exception);
}

REGISTER_TYPED_TEST_SUITE_P(FormatsRemoveAtPath, Empty, One, Odd, Even, NonObjectElemOnPath);
...
REGISTER_TYPED_TEST_SUITE_P(FormatsTypeChecks, Empty, Missing, BasicTypes, Null);
