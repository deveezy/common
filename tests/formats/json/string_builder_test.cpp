...
constexpr inline bool kIsSerializeAllowedInWriteToStream<Value, formats::json::StringBuilder> = false;
...
formats::json::Value Serialize(
    const Response200EchoobjectwithmappingA &value, formats::serialize::To<formats::json::Value>);

void WriteToStream(const Response200EchoobjectwithmappingA &value, formats::json::StringBuilder &sw,
    bool hide_brackets = false, const char *hide_field_name = nullptr);

struct Response200 {
  ::std::string object_no_mapping_type;
  ::std::vector<testing::Response200EchoobjectwithmappingA> echoobjectwithmapping;
};

void WriteToStream(const Response200 &value, formats::json::StringBuilder &sw, bool hide_brackets = false,
    const char *hide_field_name = nullptr);

void WriteToStream([[maybe_unused]] const Response200EchoobjectwithmappingA &value, formats::json::StringBuilder &sw,
    bool /*hide_brackets*/, [[maybe_unused]] const char * /*hide_field_name*/
) {
  formats::json::StringBuilder::ObjectGuard guard {sw};
}

void WriteToStream([[maybe_unused]] const Response200 &value, formats::json::StringBuilder &sw, bool hide_brackets,
  ...
  if (!hide_field_name || std::strcmp(hide_field_name, "echoObjectWithMapping") != 0) {
...
using StringBuilderIntegralTypes = ::testing::Types<signed char, short, int, long, long long,
