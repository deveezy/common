...
struct MemberAccess<formats::yaml::Value> : public ::testing::Test {
  ...
  static_assert(!std::is_assignable_v<decltype(*std::declval<formats::yaml::Value>().begin()), formats::yaml::Value>,
...
struct FormatsYamlSpecificMemberAccess : public MemberAccess<formats::yaml::Value> {};
