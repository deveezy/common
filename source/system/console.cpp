...
void Console::SetColor(Color _color, Color _background) {
  const char *colors[] = {
  ...
  std::fwrite(backgrounds[static_cast<int>(_background) - static_cast<int>(Color::BLACK)], 1, 8,
              stdout);
  std::fwrite(colors[static_cast<int>(_color) - static_cast<int>(Color::BLACK)], 1, 8, stdout);
#elif defined(_WIN32) || defined(_WIN64)
