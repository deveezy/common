...
Type GetExtendedType(const YAML::Node &val) {
  switch (val.Type()) {
    case YAML::NodeType::Sequence: return arrayValue;
    case YAML::NodeType::Map: return objectValue;
    case YAML::NodeType::Null: return nullValue;
    case YAML::NodeType::Scalar: return scalarValue;
    case YAML::NodeType::Undefined: throw std::logic_error("undefined node type should not be used");
  }
  return errorValue;
}
