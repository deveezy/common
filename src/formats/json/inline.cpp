...
static_assert(std::is_empty_v<::rapidjson::CrtAllocator>, "allocator has no state");
...
void InlineObjectBuilder::Reserve(size_t size) { json_->MemberReserve(size, g_allocator); }
...
void InlineObjectBuilder::Append(std::string_view key, long value) {
  json_->AddMember(WrapStringView(key), impl::Value {std::int64_t {value}}, g_allocator);
}

void InlineObjectBuilder::Append(std::string_view key, unsigned long value) {
  json_->AddMember(WrapStringView(key), impl::Value {std::uint64_t {value}}, g_allocator);
}
...
void InlineObjectBuilder::Append(std::string_view key, unsigned long long value) {
  json_->AddMember(WrapStringView(key), impl::Value {std::uint64_t {value}}, g_allocator);
}
...
void InlineObjectBuilder::Append(std::string_view key, const char *value) { Append(key, std::string_view {value}); }
...
void InlineObjectBuilder::Append(std::string_view key, std::chrono::system_clock::time_point value) {
  Append(key, FormatTimePoint(value));
}

void InlineObjectBuilder::Append(std::string_view key, const formats::json::Value &value) {
...
void InlineArrayBuilder::Reserve(size_t size) { json_->Reserve(size, g_allocator); }

void InlineArrayBuilder::Append(std::nullptr_t) { json_->PushBack(impl::Value {}, g_allocator); }

void InlineArrayBuilder::Append(bool value) { json_->PushBack(impl::Value {value}, g_allocator); }

void InlineArrayBuilder::Append(int value) { json_->PushBack(impl::Value {value}, g_allocator); }

void InlineArrayBuilder::Append(unsigned int value) { json_->PushBack(impl::Value {value}, g_allocator); }

void InlineArrayBuilder::Append(long value) { json_->PushBack(impl::Value {std::int64_t {value}}, g_allocator); }

void InlineArrayBuilder::Append(unsigned long value) {
  json_->PushBack(impl::Value {std::uint64_t {value}}, g_allocator);
}

void InlineArrayBuilder::Append(long long value) { json_->PushBack(impl::Value {std::int64_t {value}}, g_allocator); }
...
void InlineArrayBuilder::Append(const char *value) { Append(std::string_view {value}); }

void InlineArrayBuilder::Append(std::string_view value) { json_->PushBack(WrapStringView(value), g_allocator); }
void InlineArrayBuilder::Append(std::chrono::system_clock::time_point value) { Append(FormatTimePoint(value)); }
