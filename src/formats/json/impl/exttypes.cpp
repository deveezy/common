...
Type GetExtendedType(const Value &val) {
  switch (val.GetType()) {
    case rapidjson::kNullType: return nullValue;
    case rapidjson::kObjectType: return objectValue;
    case rapidjson::kArrayType: return arrayValue;
    case rapidjson::kStringType: return stringValue;
    case rapidjson::kTrueType:
    case rapidjson::kFalseType: return booleanValue;
