...
#include <compiler/impl/constexpr.hpp>
#include <compiler/impl/lifetime.hpp>
#include <compiler/impl/tls.hpp>
...
public:
  ...
  VariableType &operator*() & noexcept LRW_IMPL_LIFETIME_BOUND;
...
public:
  LRW_IMPL_CONSTEVAL ThreadLocal() : factory_(Factory {}) {}

  LRW_IMPL_CONSTEVAL /*implicit*/ ThreadLocal(Factory factory) : factory_(factory) {}
