...
public:
  ...
  constexpr SelectValue &ForLibCpp64(T value) noexcept { return Set(Bits::k64, StdLibs::kCpp, value); }

  constexpr SelectValue &ForLibStdCpp64(T value) noexcept { return Set(Bits::k64, StdLibs::kStdCpp, value); }

  constexpr SelectValue &ForLibCpp32(T value) noexcept { return Set(Bits::k32, StdLibs::kCpp, value); }

  constexpr SelectValue &ForLibStdCpp32(T value) noexcept { return Set(Bits::k32, StdLibs::kStdCpp, value); }

  constexpr SelectValue &For64Bit(T value) noexcept { return Set(Bits::k64, StdLibs::kAny, value); }

  constexpr SelectValue &For32Bit(T value) noexcept { return Set(Bits::k32, StdLibs::kAny, value); }
